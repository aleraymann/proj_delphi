...
uses
  ...
  uTelaHeranca in 'heranca\uTelaHeranca.pas' {formTelaHeranca},
  ...
  uCadProduto in 'cadastro\uCadProduto.pas' {frmCadastroProduto},
  ...
  uSelecioanarData in 'relatorio\uSelecioanarData.pas' {frmSelecionarData},
